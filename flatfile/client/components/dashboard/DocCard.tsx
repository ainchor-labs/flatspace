    ...
    >
      ...
      {doc.tags.length > 0 && (
        <div className="overflow-hidden px-3 pb-1">
          <TagChips tags={doc.tags} max={2} className="flex-nowrap" />
        </div>
      )}
      ...
      <div className="flex items-center gap-1.5 border-t border-border px-3 py-2.5">
        ...
        <TagPicker
          ...
          align="end"
          trigger={
            <span className="inline-flex rounded p-1 text-muted-foreground transition hover:bg-accent hover:text-foreground [&_svg]:size-4">
              <TagIcon />
            </span>
          }
        />
